...
def main():
    ...
    filter_option = st.selectbox("Filter:", ["No filter", "Vegetarian", "Nut-free", "Only Ingr"], index=0)  # add the dropdown menu for filter options
